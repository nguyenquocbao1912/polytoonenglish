...
export default async function MiniTestsPage() {
          ...
          <div className="mx-auto max-w-6xl px-4 py-8 lg:px-8">
              ...
              <div className="flex flex-col gap-4 md:flex-row md:items-center md:gap-6">
                ...
                <div className="relative flex-1">
                  ...
                  <p className="mt-2 font-semibold leading-relaxed text-[#111116]/70">
                    Practice with short tests, save time but still maintain the same difficulty.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="mb-8">
              {error ? (
                ...
                <MockTestList tests={testData || []} type="mini" />
              )}
            </section>
          </div>
